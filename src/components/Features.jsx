...
const handleMouseMove = (e) =>{
  ...
  const newTransformStyle = `perspective(700px) rotateX(${tiltY}deg) rotateY(${tiltX}deg) scale3d(0.95,0.95,0.95)`; 
...
const BentoCard = ({src, title, description}) =>{
    return(
        <div className='relative size-full  '>
            <video src={src} loop autoPlay muted className='left-0 absolute top-0 size-full object-cover object-center' />
            ...
            <div className='bento-tilt_2'>
                <div className='flex size-full flex-col justify-between bg-violet-300 p-5'>
                    <h1 className='bento-title special-font'>
                        Mo<b>r</b>e <b>c</b>oming S<b>o</b>on!
                    </h1>
